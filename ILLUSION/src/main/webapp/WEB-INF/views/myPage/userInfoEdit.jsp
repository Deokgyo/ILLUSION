			...
			<div class="form-box">
				...
				<hr>
					<table class="info-table">
						...
						<tr>
							<th>아이디</th>
							<td rowspan="1"><span class="bg-text">${selectuserInfoEdit.member_id }</span></td>

						</tr>
						<tr>
							<th>이름</th>
							<td ><span class="bg-text">${selectuserInfoEdit.member_name}</span></td>
							<td class="right-align"><button class="edit-button">수정</button></td>
						</tr>
						<tr>
							<th>생년월일</th>
							<td><span class="bg-text">${selectuserInfoEdit.resume_birth}</span></td>
							<td class="right-align"><button class="edit-button">수정</button></td>
						</tr>
						<tr>
							<th>성별</th>
							<td><span class="bg-text">${selectuserInfoEdit.gender }</span></td>
							<td class="right-align"><button class="edit-button">수정</button></td>
						</tr>
						<tr>
							<th>주소</th>
							<td><span class="bg-text">${selectuserInfoEdit.address_idx}</span></td>
							<td class="right-align"><button class="edit-button">수정</button></td>
						</tr>
						<tr>
							<th>이메일</th>
							<td><span class="bg-text">${selectuserInfoEdit.email_verified }</span></td>
							<td class="right-align"><button class="edit-button">수정</button></td>
						</tr>
					</table>
