		...
		<main class="main-content">
			...
			<div class="form-box">
				<div class="member-info-container">
					<hr>
					<form action="${pageContext.request.contextPath}/userInfoEdit"
						method="post">
						...
						<table class="info-table">
							...
							<tr>
								<th>아이디</th>
								<td rowspan="1"><input type="text" name="member_id"
									class="bg-text" value="${member.member_id}"></td>
							</tr>
							<tr>
								<th>이름</th>
							...
							<tr>
								<th>성별</th>
								<td><input type="text" name="gender" class="bg-text"
				...
				<button class="passwd-button"
					onclick="location.href='changePasswd';">비밀번호 수정</button>
